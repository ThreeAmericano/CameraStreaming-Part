...
if __name__ == "__main__":
    ...
    tc.basic_publish(exchange='', routing_key='test321',body='camera client test1')
    test_channel.publish_queue('test321', 'camera client test2')
    test_channel.publish_exchange('webos.topic', 'webos.test.info', '{hello}')
    ...
    test_channel.consume_setting('webos.test', callback)
